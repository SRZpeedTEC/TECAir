// Paleta de colores para cada estado de asiento (admin view).
// "selected" = el asiento que el funcionario esta asignando.
// "occupied" = asiento ya tomado por otro pasajero (mock por ahora).
const COLORS = {
...
// Icono SVG reutilizado del flujo cliente, sin la variante "your-other"
// porque el check-in solo asigna un asiento a la vez.
export default function SeatIcon({ variant, size = 38 }) {
