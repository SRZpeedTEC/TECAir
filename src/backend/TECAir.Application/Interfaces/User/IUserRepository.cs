...
public interface IUserRepository
{
    ...
    // Consulta datos internos para login, incluyendo password_hash solo para verificacion.
    Task<AuthenticatedUserData?> GetForLoginAsync(string email, CancellationToken cancellationToken = default);
